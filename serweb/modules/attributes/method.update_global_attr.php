...
/**
 *	@author     Karel Kozlik
 *	@version    $Id: method.update_global_attr.php,v 1.5 2009/05/06 08:41:42 kozlik Exp $
 *	@package    serweb
 *	@subpackage mod_attributes
 */ 

/**
 *	Data layer container holding the method for update global attribute
 * 
 *	@package    serweb
 *	@subpackage mod_attributes
 */ 
		...
		if (is_object($at) and $at->is_multivalue()){
			...
			foreach($value as $v){
				$q = "insert into ".$t_name."(
				             ".$c->name.", ".$c->value.", ".$c->type.", ".$c->flags.$ion.")
