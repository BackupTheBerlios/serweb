<?
/*
 * $Id: method.delete_user_phonebook.php,v 1.1 2004/08/25 10:45:58 kozlik Exp $
 */
...
class CData_Layer_delete_user_phonebook {
	...
	function delete_user_phonebook($user, &$errors){
	 	global $config;
		
		if (!$this->connect_to_db($errors)) return false;

		$q="delete from ".$config->data_sql->table_phonebook." where ".$this->get_indexing_sql_where_phrase($user);
